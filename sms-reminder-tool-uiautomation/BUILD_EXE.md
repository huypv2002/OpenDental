...
Use the GitHub Actions workflow `Build SMS Reminder UIAutomation EXE`.

1. Push this repository to GitHub.
2. Open Actions.
3. Run `Build SMS Reminder UIAutomation EXE`.
4. Download the artifact named `LUK-Dental-SMS-Reminder-UIAutomation-windows`.
5. Extract `LUK-Dental-SMS-Reminder-UIAutomation-windows.zip`.

The artifact contains:

- `LUK Dental SMS Reminder Tool UIAutomation.exe`
...
Double-click `LUK Dental SMS Reminder Tool UIAutomation.exe` or `run-sms-reminder.bat`.
